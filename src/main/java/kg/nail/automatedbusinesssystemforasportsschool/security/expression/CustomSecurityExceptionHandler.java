package kg.nail.automatedbusinesssystemforasportsschool.security.expression;
...
public class CustomSecurityExceptionHandler extends DefaultMethodSecurityExpressionHandler {
    ...
    protected MethodSecurityExpressionOperations createSecurityExpressionRoot(Authentication authentication,
        ...
        root.setAthleteService(this.applicationContext.getBean(AthleteService.class));
